  ...
  return (
    <div className="flex flex-col h-screen bg-base">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-hidden flex bg-cosmic items-center justify-center relative">
          <div className="absolute inset-0 bg-cosmic-grid pointer-events-none opacity-50" />

          <div className="relative z-10 flex flex-col items-center gap-4">
            <div className="h-16 w-16 rounded-full glass-panel-deep border border-surface-border flex items-center justify-center relative">
              <div className="absolute inset-0 rounded-full border border-brand/20 animate-ping opacity-30" />
              <div className="h-2 w-2 rounded-full bg-brand shadow-[0_0_10px_rgba(0,200,212,0.8)]" />
            </div>
            <div className="flex flex-col items-center gap-1">
              <span className="text-sm font-medium tracking-widest text-copy-primary uppercase">
                Canvas Initializing
              </span>
              <span className="text-xs text-brand/60 font-mono">
        ...
        {aiOpen && (
          <aside className="w-80 shrink-0 flex flex-col border-l border-surface-border glass-panel-deep z-20">
